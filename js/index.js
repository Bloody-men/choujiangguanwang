...
hdk.prototype={initialize:function(id)
{var _this=this;this.wrap=typeof id==="string"?document.getElementById(id):id;this.oUl=this.wrap.getElementsByTagName("ul")[0];this.aLi=this.wrap.getElementsByTagName("li");this.prev=this.wrap.getElementsByTagName("pre")[0];this.next=this.wrap.getElementsByTagName("pre")[1];this.timer=null;this.aSort=[];this.iCenter=3;this._doPrev=function(){return _this.doPrev.apply(_this)};this._doNext=function(){return _this.doNext.apply(_this)};this.options=[{width:200,height:389,top:92,left:0,zIndex:1},{width:200,height:389,top:92,left:0,zIndex:2},{width:200,height:389,top:92,left:210,zIndex:3},{width:240,height:430,top:78,left:420,zIndex:4},{width:200,height:389,top:92,left:670,zIndex:3},{width:200,height:389,top:92,left:880,zIndex:2},{width:200,height:389,top:92,left:450,zIndex:1},];for(var i=0;i<this.aLi.length;i++)this.aSort[i]=this.aLi[i];this.aSort.unshift(this.aSort.pop());this.setUp();this.addEvent(this.prev,"click",this._doPrev);this.addEvent(this.next,"click",this._doNext);this.doImgClick();this.timer=setInterval(function()
...
{this.css(this.aSort[i],"display","none");this.css(this.aSort[i],"width",0);this.css(this.aSort[i],"height",0);this.css(this.aSort[i],"top",100);this.css(this.aSort[i],"left",this.oUl.offsetWidth/2)}
